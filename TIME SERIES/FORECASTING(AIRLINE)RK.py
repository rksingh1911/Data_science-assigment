"""
Created on Sat Jun 25 15:25:11 2022
...
#loading the data
data=pd.read_excel("E:\\ExcelR\\assigment\\TIME SERIES\\Airlines+Data.xlsx")
data.shape
list(data)
data.head
...
Inference: The best fit model is Additive seasonality quadratic model with RMSE
           of 30.393 which is observed to be the least of all models
'''
