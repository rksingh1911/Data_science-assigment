# -*- coding: utf-8 -*-
"""
Created on Sat Jun 25 15:26:00 2022

@author: ROHIT SINGH
"""

#Business Problem
'''Forecast the airlines data set. Prepare a document for each model 
...
#loading the data
data=pd.read_excel("E:\\ExcelR\\assigment\\TIME SERIES\\CocaCola_Sales_Rawdata.xlsx")
data.shape
list(data)
data.head
...
Inference: The best fit model is Additive seasonality quadratic model with RMSE
           of 277.35 which is observed to be the least of all models
'''
