"""
Created on Tue May  3 00:11:14 2022
...
#Basically here we have check is there any significent diffrence between cutlet diameter or not
...
df = pd.read_csv("E:\\ExcelR\\assigment\\TEST OF Hypothesis\\Cutlets.csv")
df.shape
df.head
list(df)
type(df)
