"""
Created on Sun May  8 15:36:28 2022
...
#Basically here we have check is there any significent diffrence between TAT of laboratories or not
...
df = pd.read_csv("E:\\ExcelR\\assigment\\TEST OF Hypothesis\\LabTAT.csv")
df.head
df.shape
type(df)
list(df)
