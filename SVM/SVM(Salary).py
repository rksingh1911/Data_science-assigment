"""
Created on Thu Jun 23 00:23:36 2022
...
#loading the data
data_train = pd.read_csv("E:\\ExcelR\\assigment\\SVM\\SalaryData_Train(1).csv")
data_train.shape
list(data_train)
data_train.dtypes

data_test=pd.read_csv("E:\\ExcelR\\assigment\\SVM\\SalaryData_Test(1).csv")
data_test.shape
list(data_test)
