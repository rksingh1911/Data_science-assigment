"""
Created on Thu Jun 23 19:15:27 2022
...
#loading the data
df = pd.read_csv("E:\\ExcelR\\assigment\\Association rule\\book.csv")
df
...
#frequescy
book.sum().to_frame('Frequency').sort_values('Frequency',ascending=False)[:25].plot(kind='bar',figsize=(12,8),title="Frequent Items")
plt.show()
...
def gen_rules(df,confidence,support):
    ap = {}
    for i in confidence:
        ap_i =apriori(book,support,True)
...
asr=association_rules(freq_items,metric='lift',min_threshold=0.4) 
asr
